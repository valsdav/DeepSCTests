...
echo "step3 11846.19"
#cmsDriver.py step3  -s RAW2DIGI,L1Reco,RECO --conditions auto:phase1_2021_realistic --datatier AODSIM -n 100 --eventcontent RECOSIM --geometry DB:Extended --era Run3 --procModifiers run3_ecalclustering --pileup Run3_Flat55To75_PoissonOOTPU --pileup_input das:/RelValMinBias_14TeV/CMSSW_12_0_0_pre4-120X_mcRun3_2021_realistic_v2-v1/GEN-SIM --filein file:step2.root --fileout file:step3.root
