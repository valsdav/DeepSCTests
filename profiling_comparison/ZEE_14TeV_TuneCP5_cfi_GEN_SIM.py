...
# with command line options: ZEE_14TeV_TuneCP5_cfi -s GEN,SIM -n 100 --conditions auto:phase1_2021_realistic --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --datatier GEN-SIM --eventcontent FEVTDEBUG --geometry DB:Extended --era Run3 --relval 9000,100 --fileout file:step1.root
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('ZEE_14TeV_TuneCP5_cfi nevts:100'),
