...
process.particleFlowSuperClusterECAL.deepSuperClusterConfig.maxNClusters = cms.vuint32(0,30)
...
process.particleFlowSuperClusterOOTECAL.deepSuperClusterConfig.maxNClusters = cms.vuint32(0,30)
