...
process.particleFlowSuperClusterECAL.deepSuperClusterConfig.modelFiles = \
    cms.vstring("RecoEcal/EgammaClusterProducers/data/DeepSCModels/ACAT2022/norechits_run30/model_smallpadding.pb",
                "RecoEcal/EgammaClusterProducers/data/DeepSCModels/ACAT2022/norechits_run30/model_largepadding.pb")
