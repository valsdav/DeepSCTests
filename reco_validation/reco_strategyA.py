...
# Replace superClustering strategy

#from RecoEcal.EgammaClusterProducers.particleFlowSuperClusterECAL_cff import *
#process.particleFlowSuperClusteringTask.replace(particleFlowDeepSuperClusterECALstrategyA, particleFlowDeepSuperClusterECALstrategyB )


# DEBUG logging
#process.load("FWCore.MessageService.MessageLogger_cfi")
#process.MessageLogger.cerr.threshold = "DEBUG"
#process.MessageLogger.debugModules = ["particleFlowDeepSuperClusterECALstrategyB"]
