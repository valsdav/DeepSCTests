...
# with command line options: step2 --mc --eventcontent RECOSIM --runUnscheduled --datatier GEN-SIM-RECO --conditions 112X_mcRun3_2021_realistic_v16 --step RAW2DIGI,L1Reco,RECO,RECOSIM,PAT --nThreads 8 --geometry DB:Extended --era Run3 --fileout file:step3.root --filein file:step2.root --procModifier run3_ecalclustering
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_cff import Run3
from Configuration.ProcessModifiers.run3_ecalclustering_cff import run3_ecalclustering

process = cms.Process('RECO',Run3,run3_ecalclustering)
