...
options.register('inputName',  "hltStep.root", VarParsing.multiplicity.singleton,VarParsing.varType.string,"inputName")
options.register('outputName', "recoStep.root", VarParsing.multiplicity.singleton,VarParsing.varType.string,"outputName")
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('reco_step.py nevts:-1'),
