...
options.register('inputName',  "digirawStep.root", VarParsing.multiplicity.singleton,VarParsing.varType.string,"inputName")
options.register('outputName', "hltStep.root", VarParsing.multiplicity.singleton,VarParsing.varType.string,"outputName")
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('hlt_step.py nevts:-1'),
