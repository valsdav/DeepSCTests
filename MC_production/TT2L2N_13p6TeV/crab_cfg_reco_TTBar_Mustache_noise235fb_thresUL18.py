...
config.General.requestName       = 'TT2L2Nu_13p5TeV_EcalNoise235fb_Mustache_thresUL18'
...
config.JobType.psetName          = 'RecoSimDumper_fromRAW_Mustache_StdMC_noise235_thresUL18_cfg.py'
...
config.Data.outputDatasetTag     = 'RECO_Mustache_thresUL18'
